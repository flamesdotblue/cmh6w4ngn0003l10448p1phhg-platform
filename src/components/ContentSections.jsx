...
import { HeartPulse, Stethoscope, Pill, FlaskConical, BedDouble, Building2, Users, Shield } from "lucide-react";
    ...
    <section id="overview" className="relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-6">
          <InfoCard title="Government vs Private" items={["Gov: Aggregated health board view","Gov: Subsidy/insurance, compliance","Private: Independent tenant & billing"]} />
