      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            >
              luxuryHMSPRO is a multi-tenant, low-bandwidth, offline-ready HMS connecting doctors, nurses, patients, and administrators across departments with secure, real-time operations.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <a
                href="#overview"
                className="inline-flex items-center rounded-md border border-yellow-500/40 bg-neutral-900/50 px-4 py-2 text-yellow-300 hover:bg-neutral-800"
              >
                Explore PRD
              </a>
              <a
                href="#contact"
                className="inline-flex items-center rounded-md bg-gradient-to-r from-yellow-300 to-amber-500 text-neutral-900 font-medium px-4 py-2"
              >
                Contact Stakeholder Team
              </a>
            </motion.div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative rounded-2xl border border-yellow-500/30 bg-gradient-to-br from-neutral-900 via-neutral-900 to-neutral-800 p-6 shadow-[0_0_60px_rgba(180,140,20,0.15)]">
              ...
              <div className="mt-6 text-xs text-neutral-400">
                Built with Next.js, Supabase, Tailwind, and Framer Motion.
              </div>
            </div>
          </motion.div>
        </div>
